...
let item_4;
//item_4 = "YПрисвоить переменной item_4 строку “Yolochka”
item_4 = "Yolochka";
//Вывести в консоль item_4.
console.log(item_4);
//Вывести в консоль сложение item_3 и item_4.
let sun_body = +item_3 + item_4
console.log(sun_body);
// Вывести в консоль умножение item_3 и item_4.
let sun_body_1 = +item_3 * item_4
...
console.log("item_6 ==", item_6, "type item_6 ==", typeof item_6);
//Создать переменную item_7 и в ней преобразовать item_6 в String.
let item_7 = (item_6 = String);
...
console.log("item=7 ==", item_7, "type item_7 ==", typeof item_7);
